...
import com.SMMS.service.IStudentService;
...
//		//System.out.println(studentAddressDto.getStudent() + ", " + studentAddressDto.getAddress());
	...
	@PostMapping
	public ResponseEntity<Student> saveStudentDetails(@RequestBody Student  newStudent){
		return new ResponseEntity<Student>(studentService.saveStudentDetails(newStudent), HttpStatus.OK);
	}
