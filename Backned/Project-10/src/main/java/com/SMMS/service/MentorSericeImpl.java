...
import com.SMMS.entities.Course;
import com.SMMS.entities.Mentor;
import com.SMMS.entities.Student;
import com.SMMS.repository.AddressRepository;
import com.SMMS.repository.CourseRepository;
...
public class MentorSericeImpl implements IMentorService {
	...
	public Student updateMarks(int studentId, Student newMarks) {
		...
		Student student = studentRespository.findById(studentId).orElseThrow(() -> new ResourceNotFoundException("Student Does Not Exist"));
		student.setStudentMarks(newMarks.getStudentMarks());
		studentRespository.save(student);
		return student;
	}
